...
@section('content')
<section class="relative w-full h-full py-40 min-h-screen bg-gradient-to-r from-orange-500 via-amber-500 to-orange-400">
                ...
                <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
                    <div class="rounded-t mb-0 px-6 py-6">
                        <div class="text-center mb-3">
                            <img  class="md:w-10/12 p-2 mb-3 mx-auto" src="{{ asset('images/sonef.png')}}" alt="echkili_logo">
