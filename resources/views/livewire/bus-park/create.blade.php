<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('busPark.name') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('busPark.code') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('busPark.country_id') ? 'invalid' : '' }}">
        <label class="form-label" for="country">{{ trans('cruds.busPark.fields.country') }}</label>
        <x-select-list class="form-control" id="country" name="country" :options="$this->listsForFields['country']" wire:model="busPark.country_id" />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('busPark.city_id') ? 'invalid' : '' }}">
        <label class="form-label" for="city">{{ trans('cruds.busPark.fields.city') }}</label>
        <x-select-list class="form-control" id="city" name="city" :options="$this->listsForFields['city']" wire:model="busPark.city_id" />
        <div class="validation-message">
