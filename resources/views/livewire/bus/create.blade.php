<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('bus.bus_number') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('bus.counetr') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('bus.mark') ? 'invalid' : '' }}">
