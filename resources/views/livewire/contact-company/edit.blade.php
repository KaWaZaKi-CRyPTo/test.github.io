<form wire:submit.prevent="submit" class="pt-3">
    <div class="w-full flex flex-auto">
        <div class="form-group w-1/2 {{ $errors->has('contactCompany.company_name') ? 'invalid' : '' }}">
        ...
        <div class="form-group w-1/2 {{ $errors->has('contactCompany.company_address') ? 'invalid' : '' }}">
            <label class="form-label" for="company_address">{{ trans('cruds.contactCompany.fields.company_address')
                }}</label>
    ...
    <div class="w-full flex flex-auto">
        <div class="form-group w-1/2 {{ $errors->has('contactCompany.company_website') ? 'invalid' : '' }}">
            <label class="form-label" for="company_website">{{ trans('cruds.contactCompany.fields.company_website')
                }}</label>
        ...
        <div class="form-group w-1/2 {{ $errors->has('contactCompany.company_email') ? 'invalid' : '' }}">
            <label class="form-label" for="company_email">{{ trans('cruds.contactCompany.fields.company_email')
                }}</label>
