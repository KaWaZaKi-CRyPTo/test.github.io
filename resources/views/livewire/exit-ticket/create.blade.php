<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('exitTicket.product_id') ? 'invalid' : '' }}">
        <label class="form-label" for="product">{{ trans('cruds.exitTicket.fields.product') }}</label>
        <x-select-list class="form-control" id="product" name="product" :options="$this->listsForFields['product']" wire:model="exitTicket.product_id" />
    ...
    <div class="form-group {{ $errors->has('exitTicket.date') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('exitTicket.qtt') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('exitTicket.bus_number_id') ? 'invalid' : '' }}">
        <label class="form-label" for="bus_number">{{ trans('cruds.exitTicket.fields.bus_number') }}</label>
        <x-select-list class="form-control" id="bus_number" name="bus_number" :options="$this->listsForFields['bus_number']" wire:model="exitTicket.bus_number_id" />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('exitTicket.number_exit_ticker') ? 'invalid' : '' }}">
        <label class="form-label" for="number_exit_ticker">{{ trans('cruds.exitTicket.fields.number_exit_ticker') }}</label>
        <input class="form-control" type="text" name="number_exit_ticker" id="number_exit_ticker" wire:model.defer="exitTicket.number_exit_ticker">
        <div class="validation-message">
