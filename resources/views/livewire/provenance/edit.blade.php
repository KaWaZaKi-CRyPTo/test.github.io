<form wire:submit.prevent="submit" class="pt-3">
    <div class="w-full flex flex-auto">
        <div class="form-group w-1/2 {{ $errors->has('provenance.name') ? 'invalid' : '' }}">
        ...
        <div class="form-group w-1/2 {{ $errors->has('provenance.distance') ? 'invalid' : '' }}">
            ...
            <input class="form-control" type="text" name="distance" id="distance"
                wire:model.defer="provenance.distance">
            <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('provenance.country_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" required id="country" name="country"
            :options="$this->listsForFields['country']" wire:model="provenance.country_id" />
        <div class="validation-message">
