<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('route.name') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('route.start_provenance_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" id="start_provenance" name="start_provenance" :options="$this->listsForFields['start_provenance']" wire:model="route.start_provenance_id" />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('route.end_provenance_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" id="end_provenance" name="end_provenance" :options="$this->listsForFields['end_provenance']" wire:model="route.end_provenance_id" />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('route.distance') ? 'invalid' : '' }}">
        <label class="form-label" for="distance">{{ trans('cruds.route.fields.distance') }}</label>
        <input class="form-control" type="number" name="distance" id="distance" wire:model.defer="route.distance" step="1">
        <div class="validation-message">
