<form wire:submit.prevent="submit" class="pt-3">
    <div class="w-full flex flex-auto">
        <div class="form-group w-1/2 {{ $errors->has('vidangeControle.bus_id') ? 'invalid' : '' }}">
            <label class="form-label required" for="bus">{{ trans('cruds.vidangeControle.fields.bus') }}</label>
            <x-select-list class="form-control" required id="bus" name="bus" :options="$this->listsForFields['bus']"
                wire:model="vidangeControle.bus_id" />
        ...
        <div class="form-group w-1/2 {{ $errors->has('vidangeControle.oil_id') ? 'invalid' : '' }}">
            <label class="form-label required" for="oil">{{ trans('cruds.vidangeControle.fields.oil') }}</label>
            <x-select-list class="form-control" required id="oil" name="oil" :options="$this->listsForFields['oil']"
                wire:model="vidangeControle.oil_id" />
            <div class="validation-message">
    ...
    <div class="w-full flex flex-auto">
        <div class="form-group w-1/2 {{ $errors->has('vidangeControle.anicien_number') ? 'invalid' : '' }}">
            <label class="form-label required" for="anicien_number">{{
                trans('cruds.vidangeControle.fields.anicien_number')
                }}</label>
            <input class="form-control" type="number" name="anicien_number" id="anicien_number" required
                wire:model.defer="vidangeControle.anicien_number" step="1">
            <div class="validation-message">
        ...
        <div class="form-group w-1/2 {{ $errors->has('vidangeControle.new_number') ? 'invalid' : '' }}">
            <label class="form-label required" for="new_number">{{ trans('cruds.vidangeControle.fields.new_number')
                }}</label>
            <input class="form-control" type="number" name="new_number" id="new_number" required
                wire:model.defer="vidangeControle.new_number" step="1">
            <div class="validation-message">
    ...
    <div class="w-full flex flex-auto">
        <div class="form-group w-1/2 {{ $errors->has('vidangeControle.last_date') ? 'invalid' : '' }}">
            <label class="form-label" for="last_date">{{ trans('cruds.vidangeControle.fields.last_date') }}</label>
            <x-date-picker class="form-control" wire:model="vidangeControle.last_date" id="last_date" name="last_date"
                picker="date" />
            <div class="validation-message">
        ...
        <div class="form-group w-1/2 {{ $errors->has('vidangeControle.date') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('vidangeControle.oil_qtt') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="number" name="oil_qtt" id="oil_qtt" required
            wire:model.defer="vidangeControle.oil_qtt" step="1">
        <div class="validation-message">
